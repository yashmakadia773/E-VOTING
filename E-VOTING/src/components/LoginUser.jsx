                    ...
                    <div className="right-side col-6 d-flex justify-content-center align-items-center" >
                        ...
                        <div class="container">
                            <div class="card">
                                ...
                                <button type="submit" className='lgnbtn mt-4  w-100' onClick={handleSubmit} >Login</button>
                                <Link to={'/adminlogin'}> <button type="submit" className='lgnbtn mt-4  w-100' >Admin Login</button></Link>
