      ...
      >
        ...
        <Grid item xs={12} sm={4}>
          <FormControl fullWidth sx={{ marginBottom: 2 }}>
            <select className='selectparty'  value={selectedElection} onChange={(e) => setSelectedElection(e.target.value)}>
          ...
          <FormControl fullWidth sx={{ marginBottom: 2 }}>
            <select className='selectparty' value={selectedParty} onChange={(e) => setSelectedParty(e.target.value)}>
